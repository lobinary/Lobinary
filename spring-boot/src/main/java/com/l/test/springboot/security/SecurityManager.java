package com.l.test.springboot.security;
...
@Service
public class SecurityManager implements AccessDecisionManager {
    ...
    public void decide(Authentication authentication, Object object, Collection<ConfigAttribute> configAttributes) throws InsufficientAuthenticationException {
        logger.info("configAttributes:"+configAttributes+",authentication:"+authentication);
