package com.lobinary.platform.dto;
...
public class InteractionMessage implements Serializable{
	...
	public String toString() {
		return "InteractionMessage [id=" + id + ", senderId=" + senderId
				+ ", receiverId=" + receiverId + ", messageType=" + messageType
				+ ", messageInfo=" + messageInfo + ", sendDate=" + sendDate
				+ ", receiveDate=" + receiveDate + ", sendStatus=" + sendStatus
				+ "]";
	}
