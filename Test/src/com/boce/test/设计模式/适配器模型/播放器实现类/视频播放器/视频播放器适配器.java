package com.boce.test.设计模式.适配器模型.播放器实现类.视频播放器;

import com.boce.test.设计模式.适配器模型.播放器;
import com.boce.test.设计模式.适配器模型.播放器实现类.视频播放器.视频播放器实现类.视频AVI播放器;
import com.boce.test.设计模式.适配器模型.播放器实现类.视频播放器.视频播放器实现类.视频MP4播放器;
