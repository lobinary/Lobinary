...
import com.boce.test.设计模式.模板模式.实现类.街机游戏;
import com.boce.test.设计模式.模板模式.实现类.黄卡游戏;
...
public class 模板模式 {
	 ...
	 * 个人理解：
	 * 
	 * 		模板模式是一个常用模式，在许多执行方案中都可以使用
	 * 
	 * 		当子类的执行方案有共同的方法时，可以提取到模板类中，并且在模板类中控制方法的调用顺序，并把这个控制方法写成final型，达到控制子类目的
	 */
