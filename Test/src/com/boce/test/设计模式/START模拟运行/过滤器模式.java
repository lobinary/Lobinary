...
import com.boce.test.设计模式.过滤器模式.过滤器.实现类.And过滤器;
import com.boce.test.设计模式.过滤器模式.过滤器.实现类.OR过滤器;
import com.boce.test.设计模式.过滤器模式.过滤器.实现类.四边形过滤器;
import com.boce.test.设计模式.过滤器模式.过滤器.实现类.红色过滤器;
import com.boce.test.设计模式.过滤器模式.过滤器.实现类.蓝色过滤器;
