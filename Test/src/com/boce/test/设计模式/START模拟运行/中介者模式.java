...
import com.boce.test.设计模式.中介者模式.中介者.实现类.中介者;
import com.boce.test.设计模式.中介者模式.同事类.同事类抽象类;
import com.boce.test.设计模式.中介者模式.同事类.实现类.同事类A;
import com.boce.test.设计模式.中介者模式.同事类.实现类.同事类B;
 ...
 * 中介者模式
	...
	****************************************************************************************
	适用场景
	       ...
	       因此，大多数情况下，将对象间的依赖关系封装的同事类内部就可以的，
...
public class 中介者模式 {
	...
	public static void main(String[] args) {
		...
		System.out.println(同事A.getNum());
		System.out.println(同事B.getNum());
		
		中介者抽象类 中介者 = new 中介者(同事A,同事B);

		同事A.changeNum(52000, 中介者);

		System.out.println(同事A.getNum());
		System.out.println(同事B.getNum());
		
		同事B.changeNum(123, 中介者);
