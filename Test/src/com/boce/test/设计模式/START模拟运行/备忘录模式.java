...
import com.boce.test.设计模式.备忘录模式.宽接口.备忘对象保存库宽接口;
import com.boce.test.设计模式.备忘录模式.宽接口.备忘对象宽接口;
import com.boce.test.设计模式.备忘录模式.窄接口.备忘对象;
import com.boce.test.设计模式.备忘录模式.窄接口.备忘对象保存库;
