 ...
 * @since 2015年7月28日 下午5:27:44
 * @version V1.0.0 描述 : 创建文件高并发附属对象
 * 
 *         
 * 
 */
public class 高并发附属对象 {
	...
	/**
	 * 具体注释请点击Also see
	 * @see com.lobinary.test.normal.高并发附属对象#a
	 * @return the a
	 */
	public String getA() {
		return a;
	...
	/**
	 * 具体注释请点击Also see
	 * @see com.lobinary.test.normal.高并发附属对象#b
	 * @return the b
	 */
	public String getB() {
		return b;
	...
	/**
	 * 具体注释请点击Also see
	 * @see com.lobinary.test.normal.高并发附属对象#c
	 * @return the c
	 */
	public String getC() {
		return c;
