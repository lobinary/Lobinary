                                           ...
                                           Serializable
{
     ...
     * <p>
     * 直接几何API的伪参数(setLocation,setBounds setSize to signal setBounds什么正在改变,应该在TreeLock下使用,这只是因为无法改变公共和不赞成的方法
     * 的交叉调用顺序。
     * 
     */
    ...
    public enum BaselineResizeBehavior {
         ...
         * <pre>
         * Dimension preferredSize = component.getPreferredSize(); int baseline = getBaseline(preferredSize.widt
         * h,preferredSize.height); int nextBaseline = getBaseline(preferredSize.width,preferredSize.height + 1)
         * ; //计算基线//到达特定高度的位置时,添加到高度的数量：int padding = 0; //其中基线相对于中点int baselineOffset = baseline  -  height / 
         * 2; if(preferredSize.height％2 == 0&amp;&amp; baseline！= nextBaseline){padding = 1; } else if(preferred
         * Size.height％2 == 1&amp;&amp;&amp; baseline == nextBaseline){baselineOffset--; padding = 1; } //以下计算基线
         * 到达高度z的位置：int calculatedBaseline =(z + padding)/ 2 + baselineOffset;。
         * </pre>
         */
        CENTER_OFFSET,
     ...
     *  "null"值表示组件具有正常形状(或根本没有形状),applyCompoundShape()将跳过与正常形状相同的下列形状。
     * 
     */
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,程序不应该直接操纵对等体;替换为<code> boolean isDisplayable()</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> setEnabled(boolean)</code>。
     * 
     */
    @Deprecated
    public void enable() {
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> setVisible(boolean)</code>。
     * 
     */
    @Deprecated
    public void show() {
     ...
     * <p>
     *  由于本机事件处理的异步性质,此方法可以返回过时的值(例如,在快速连续的<code> setLocation()</code>的多个调用之后)。
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> getLocation()</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> setLocation(int,int)</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated自JDK版本1.1,替换为<code> getSize()</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated自JDK版本1.1,替换为<code> setSize(int,int)</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated自JDK版本1.1起,替换为<code> setSize(Dimension)</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> getBounds()</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> setBounds(int,int,int,int)</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     * 不透明的组件绘制矩形区域内的每个像素。非不透明组件仅绘制其某些像素,从而允许其下方的像素"透过"。因此,不完全涂覆其像素的组件提供一定程度的透明度。
     * <p>
     ...
     * <p>
     *  @deprecated自JDK版本1.1起,替换为<code> getPreferredSize()</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> getMinimumSize()</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> doLayout()</code>。
     * 
     */
    @Deprecated
    public void layout() {
     ...
     * <p>
     *  将光标图像设置为指定的光标。当此组件的<code>包含</code>方法对当前光标位置返回true,并且此组件可见,可显示和启用时,将显示此光标图像。
     * 设置<code> Container </code>的光标会导致游标显示在所有容器的子组件中,除非有<code> null </code>光标。
     * <p>
     ...
     * 覆盖此方法的Component的子类应该从它们的<code> update </code>方法中直接调用<code> super.update(g)</code>或调用<code> paint(g)</code>
     * 。
     * 这个方法通常被需要做额外工作的子类覆盖,以响应对<code> repaint </code>的调用。
     * <p>
    ...
    protected class BltBufferStrategy extends BufferStrategy {
         ...
         * 子类(例如,BltSubRegionBufferStrategy和FlipSubRegionBufferStrategy)可以具有区域特定的show方法,该方法使用缓冲区的实际子区域调用该方法。
         * 
         */
        void showSubRegion(int x1, int y1, int x2, int y2) {
            if (backBuffers == null) {
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为contains(int,int)。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为getComponentAt(int,int)。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为<code> dispatchEvent(AWTEvent e)</code>。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为dispatchEvent(AWTEvent)。
     * 
     */
    @Deprecated
     ...
     *
     * <p>
     *  处理在此组件上发生的事件。默认情况下,此方法为给定类的事件调用适当的<code> process&lt; event&nbsp; type&gt; Event </code>方法。
     ...
     * 
     * <p>
     * 如果为<code> Component </code>启用了键事件,当前<code> KeyboardFocusManager </code>确定是否应该将键事件分派到注册的<code> KeyList
     * ener </code>对象。
     ...
     * <p>
     *  除非为此组件启用了输入法事件,否则不会调用此方法。当出现以下情况之一时,将启用输入法事件：
     * <ul>
     ...
     * <p>
     *  @deprecated自JDK 1.1版本替换为processEvent(AWTEvent)。
     * 
     */
    @Deprecated
     ...
     * <p>
     * @deprecated自JDK版本1.1,替换为processMouseEvent(MouseEvent)。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated自JDK版本1.1,替换为processMouseMotionEvent(MouseEvent)。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为processKeyEvent(KeyEvent)。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated自JDK版本1.1开始,应将此组件注册为触发操作事件的组件上的ActionListener。
     * 
     */
    @Deprecated
     ...
     * <p>
     *  @deprecated从JDK版本1.1开始,替换为processFocusEvent(FocusEvent)。
     * 
     */
    @Deprecated
     ...
     * <p>
     * 因为这种方法的焦点行为是平台相关的,所以强烈建议开发人员尽可能使用<code> requestFocusInWindow </code>。
     * <p>
     *  将尽一切努力确保作为此请求的结果生成的<code> FocusEvent </code>具有指定的临时值。
     * 然而,因为指定任意临时状态可能不能在所有本地窗口系统上实现,所以仅对于轻的<code> Component </code>可以保证该方法的正确行为。
     ...
     *
     * <p>
     *  请求此组件获取输入焦点,如果此组件的顶级祖先已经是焦点窗口。该组件必须是可显示的,可聚焦的,可见的,并且其所有祖先(除了顶级窗口之外)必须对于要授予的请求可见。
     * 将尽一切努力兑现这一要求;然而,在一些情况下,可能不可能这样做。在此组件接收到FOCUS_GAINED事件之前,开发人员不得假设此组件是焦点所有者。
     * <p>
     * 此方法返回一个布尔值。如果返回<code> false </code>,则请求<b>保证失败</b>。
     * 如果返回<code> true </code>,则请求将成功<b>除非</b>被否决,或者在处理组件的对等体之前发生异常事件,本地窗口系统。
     ...
     * <p>
     * @deprecated从JDK版本1.1开始,替换为transferFocus()。
     * 
     */
    @Deprecated
     ...
     * 但是,如果此组件的焦点循环根是一个窗口,则焦点所有者将设置为焦点循环根的默认组件以进行焦点调整,并且当前焦点循环根不变。
     * 
     * 
     * @see       #requestFocus()
     * @see       Container#isFocusCycleRoot()
     ...
     * <p>
     * 检查此组件是否满足要求的焦点所有者： - 它是启用,可见,可聚焦 - 它的父级都启用并显示 - 顶级窗口是可聚焦的 - 如果焦点循环根目录有DefaultFocusTraversalPolicy,那么它
     * 还检查该策略接受这个组件作为焦点所有者。
     * 
     * 
     * @since 1.5
    ...
    protected abstract class AccessibleAWTComponent extends AccessibleContext
         ...
         *
         * <p>
         * 确定对象是否正在显示。这是通过检查对象和对象的祖先的可见性来确定的。注意：即使对象被另一个对象遮盖,这将返回true(例如,它恰好在下拉的菜单下)。
         * 
         * 
