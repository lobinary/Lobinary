 ...
 *
 * <p>
 * 版权所有（c）1995,2013,Oracle和/或其附属公司。版权所有。 ORACLE专有/保密。使用须遵守许可条款。
 * 
 */
package java.awt;
 ...
 * <p>
 * <img src ="doc-files / MenuBar-1.gif"alt ="标记为示例的菜单,包含基本,简单,检查和更多示例Check项目是一个CheckBoxMenuItem实例,处于关闭状
 * 态。
 * style="float:center; margin: 7px 10px;">
 * <p>
 ...
 * 由于事件是<code> ItemEvent </code>的一个实例,<code> processEvent </code>方法检查事件并将其传递给<code> processItemEvent </c
 * ode>。
 * 
 * 
 * @author      Sami Shaio
 ...
 * @since       JDK1.0
 */
public class 测试翻译效果 extends MenuItem implements ItemSelectable, Accessible {
    ...
    static {
        ...
        AWTAccessor.setCheckboxMenuItemAccessor(
            new AWTAccessor.CheckboxMenuItemAccessor() {
                public boolean getState(测试翻译效果 cmi) {
                    return cmi.state;
                }
            });
    }
    ...
    */
     ...
     * returns true
     * <p>
     * 创建带有空标签的复选框菜单项。项目的状态最初设置为"关闭"。 @exception HeadlessException如果GraphicsEnvironment.isHeadless（）返回tru
     * 
     * 
     * @see java.awt.GraphicsEnvironment#isHeadless
     * @since   JDK1.1
     */
    public 测试翻译效果() throws HeadlessException {
        this("", false);
    }
     ...
     * @see java.awt.GraphicsEnvironment#isHeadless
     */
    public 测试翻译效果(String label) throws HeadlessException {
        this(label, false);
    }
     ...
     * @since      JDK1.1
     */
    public 测试翻译效果(String label, boolean state)
     ...
     * 
     * @返回此复选框菜单项的状态,其中<code> true </code>表示"on",<code> false </code>表示"
     * 
     * 
     * @see        #setState
     */
     ...
     * 
     * @返回所有这个复选框menuitem的<code> ItemListener </code> s或一个空数组,如果没有项目监听器当前注册
     * 
     * 
     * @see           #addItemListener
     * @see           #removeItemListener
     ...
     * <p>
     * 除非为此菜单项启用项事件,否则不会调用此方法。当发生以下任一情况时,将启用项事件
     * <ul>
     ...
     *
     * <p>
     * 读取<code> ObjectInputStream </code>,如果不是<code> null </code>添加了一个监听器来接收由<code>复选框</code>菜单项触发的项目事件。
     * 
     * 
...
////////////////
     ...
     * 
     * @返回一个AccessibleAWTCheckboxMenuItem作为此CheckboxMenuIte的AccessibleContext
     * 
     * 
     * @since 1.3
     */
        ...
        implements AccessibleAction, AccessibleValue
    {
         ...
         * @return this object
         * <p>
         * 获取与此对象关联的AccessibleAction。在为此类实现Java辅助功能API时,返回此对象,该对象负责代表自身实现AccessibleAction接口。
         * 
         * @return这个对象
         * 
         */
