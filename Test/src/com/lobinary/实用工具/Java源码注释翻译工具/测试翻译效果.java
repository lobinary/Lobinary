 ...
 *
 * <p>
 * 版权所有（c）2005,2013,Oracle和/或其附属公司。版权所有。 ORACLE专有/保密。使用须遵守许可条款。
 * 
 */
 ...
 *
 * <p>
 * 桥梁JSR 199,JSR 269,和树API。
 * 
 * 
 * @author Peter von der Ah&eacute;
 */
@jdk.Exported
public abstract class 测试翻译效果 {
    /**
     ...
     */
    public static 测试翻译效果 instance(CompilationTask task) {
     ...
     */
    public static 测试翻译效果 instance(ProcessingEnvironment env) {
    ...
    static 测试翻译效果 getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            return (测试翻译效果) m.invoke(null, new Object[] { arg });
        } catch (Throwable e) {
