package com.lobinary.设计模式.桥接模式.配套模式之工厂模式;

import com.lobinary.设计模式.桥接模式.路.实现类.乡间小路;
import com.lobinary.设计模式.桥接模式.路.实现类.高速公路;
import com.lobinary.设计模式.桥接模式.车.车;
import com.lobinary.设计模式.桥接模式.车.实现类.大卡车;
import com.lobinary.设计模式.桥接模式.车.实现类.小汽车;
