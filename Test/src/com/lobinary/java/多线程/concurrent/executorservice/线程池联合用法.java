...
public class 线程池联合用法 {
	...
	private final static ExecutorService refundQueryThreadPool = new ThreadPoolExecutor(1, 1, 30, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(20));// 20
																																							// 全服务器只允许有20个线程同时访问退款中心查询退款记录
 ...
 * @date 2017年2月22日 上午10:59:19
 * @version V1.0.0
 */
class 测试线程 implements Callable<List<String>> {
