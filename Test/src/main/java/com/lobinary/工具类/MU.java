...
//		send2MailServer(session, message);
	...
	public static boolean sendMail(String title, String mailInfo, String senderDisplayName,String receiveMail) throws UnsupportedEncodingException, MessagingException {
		Map<String, String> receiveMailMap = new HashMap<String,String>();
		receiveMailMap.put(receiveMail, "收件方");
		return sendMail(null, title, mailInfo, null, null,senderDisplayName, receiveMailMap , null, null);
	}
